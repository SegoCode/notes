...
2. **Habilitar y configurar el procesador:**
   ...
   <Aside type="caution">
   En proyectos con varios módulos, es posible que la configuración del procesador ya exista en alguno de ellos. Comprueba si otro módulo tiene el annotation processor habilitado y utiliza la misma configuración. Además, esta configuración puede desconfigurarse de forma inesperada tras reimportar el proyecto o invalidar cachés del IDE, por lo que conviene verificarla si los Mappers dejan de generarse.
   </Aside>
