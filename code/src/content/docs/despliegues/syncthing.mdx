...
Esta guía explica cómo crear un sistema de backup de fotos en un servidor Linux (por ejemplo, una Raspberry Pi) utilizando Syncthing y Docker, sin necesidad de configuraciones de red complejas ni apertura de puertos o IP estáticas.
...
3. **Conectar y configurar el almacenamiento externo (Opcional)**
   ...
   <Steps>
     1. **Obtener el UUID del dispositivo de almacenamiento**
        ...
        Ejecuta el siguiente comando para obtener el UUID del dispositivo conectado:
...
Descarga la aplicación móvil de Syncthing desde la [Google Play Store](https://play.google.com/store/apps/details?id=com.github.catfriend1.syncthingandroid&hl=es_419) o la [App Store](https://apps.apple.com/us/app/m%C3%B6bius-sync/id1539203216) la aplicación móvil permite conectarse al servidor mediante un código QR, sin necesidad de configurar IP estáticas ni abrir puertos.
