...
<CardGrid>
  ...
  <LinkCard href="https://github.com/sourcegit-scm/sourcegit" title="Sourcegit" description="Cliente gráfico de Git, ligero y multiplataforma." />
  ...
  <LinkCard href="https://github.com/refined-github/refined-github" title="Refined Github" description="Extensión del navegador con funcionalidades adicionales para GitHub." />
  <LinkCard href="https://github.com/material-extensions/material-icons-browser-extension" title="Material icons Github" description="Extensión que añade iconos Material a los archivos en GitHub." />
</CardGrid>

### Limpieza de ramas antiguas

Script de PowerShell que identifica ramas remotas con más de N meses de inactividad y permite eliminarlas de forma interactiva. Configura el umbral modificando la variable `$monthsOld`:
...
<Aside type="caution">
El script elimina ramas tanto en remoto (`git push --delete origin`) como en local (`git branch -d`). Verifica las ramas listadas antes de confirmar la eliminación.
</Aside>
```
